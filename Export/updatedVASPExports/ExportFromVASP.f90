            ...
            do iA = 1, T_INFO%NIONS
              ...
              do ilm = 1, WDES%LMMAX(iT)
                do ipw = 1, WDES%NGVECTOR(ik)
                  ...
                  !! It seems that the stored projectors are <beta|
                  write(82,'(2ES24.15E3)') conjg(NONL_S%QPROJ(ipw,ilm,iT,ik,1)*NONL_S%CREXP(ipw,iA)*NONL_S%CQFAK(ilm,iT)) ! We are writing |beta>.
                  !! NONL_S%LSPIRAL = .FALSE. Spin spirals are not calculated.
                  !! So NONL_S%QPROJ is spin-independent.
              ...
              lmbase = lmbase + WDES%LMMAX(iT)
                ...
                !! of the next atom
                !! Do not need it. There is a dimension of NIONS. 

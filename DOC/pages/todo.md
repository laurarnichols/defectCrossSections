...
* `../TME/src/TME_Module_v28.f90:894: Change `(posIonPC(j,ni) , j = 1,3)` to `posIonPC(1:`3,ni)` in `readInputPC()` for clarity
* `../TME/src/TME_Module_v28.f90:966:` Look more into how AE and PS wavefunctions are combined to further understand this
* `../TME/src/TME_Module_v28.f90:967:` Move this behavior to another subroutine for clarity
* `../TME/src/TME_Module_v28.f90:1302:` Combine `readInputSD()` and `readInputPC()`

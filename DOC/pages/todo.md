...
* `../Mj/src/Mj_Module_v1.f90:332:` Figure out why there is no \(N\) in this equation in the code 
* `../Mj/src/Mj_Module_v1.f90:342:` Figure out if this needs to be another variable 
* `../Mj/src/Mj_Module_v1.f90:365:` Frequency should actually be in eV/\(\hbar\). Check that that's the case. 
* `../Mj/src/Mj_Module_v1.f90:381:` Figure out why this is assigned to another variable 
* `../Mj/src/Mj_Module_v1.f90:386:` Figure out if still need `di`, `bk`, and `dk` 
* `../Mj/src/Mj_Module_v1.f90:393:` Figure out if need to have this in loop. Why change `nm` in `iknb`? 
* `../Mj/src/Mj_Module_v1.f90:396:` Figure out if should send `nm` as it is immediately modified and not used here 
* `../Mj/src/Mj_Module_v1.f90:400:` Possibly change `besOrderNofModeM` to `modBesOrderNofModeM` 
* `../Mj/src/Mj_Module_v1.f90:401: Figure out why this loop is here. Can not just pass `besOrderNofModeM(:`,j)` 
* `../Mj/src/Mj_Module_v1.f90:438:` Figure out if expect `modeI` and `modeF` to represent index of magnitude of argument `x` 
* `../Mj/src/Mj_Module_v1.f90:550:` Make this loop more clear 
